...
class _WatchTabState extends State<WatchTab> {
  String videoUrl1 = 'https://www.youtube.com/watch?v=6Hvc-xpNTME&ab_channel=T-Series';
  YoutubePlayerController _controller1;

  String videoUrl2 = 'https://www.youtube.com/watch?v=IuS4LL_ALrU&ab_channel=LahariMusic%7CT-Series';
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('Pramod Kitti', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0)),
                            SizedBox(height: 5.0),
                            Text('7h')
                          ],
                        ),
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('Madhu La', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0)),
                            SizedBox(height: 5.0),
                            Text('10h')
                          ],
                        ),
